/*
    ...
    March 2020.
*/
var php_upload_path = link_url + "admin/content/upload";
(function(factory) {
    /* global define */
    ...
    $.extend($.summernote.plugins, {
        ...
        'ajaximageupload': function(context) {
            ...
            this.initialize = function() {
                this.$panel = $('<div class="ajaxfileupload-panel"><div id="ajaxFileUploadInner"><div id="ajaxPanelClose">+</div><div id="fileUploadGroup"><h4>Оруулах зургаа сонгоно уу:</h4><br /><input type="file" id="file" name="file" class="form-control mb-5" /></div><div id="ajaxFileUploadSubmit" class="btn btn-primary mt-5">Хуулах</div></div></div>').css({
                    position: 'fixed',
                    width: 400,
                    height: 200,
                    left: '50%',
