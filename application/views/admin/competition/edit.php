...
<div class="content-body">
    <div class="container-fluid">
        <div class="page-titles form-head d-flex flex-wrap justify-content-between align-items-center mb-4">
            <h2 class="text-black font-w500 mb-0 me-auto mb-2 pe-3">Тэмцээний оноолт засах</h2>
                                ...
                                <div class="col-xl-12">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-12">
                                            <select class="default-select wide form-control" id="competition_category_id" name="competition_category_id" required>
                                                ...
                                                <?php
                                                foreach ($competition_category as $item) {
                                                    if ($item->id == $competition_category_id) {
                                                ?>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-12">
                                            <select onchange="selectType();" class="default-select wide form-control" id="play_status" name="play_status">
                                                <option <?php if ($play_status == 0) echo "selected" ?> value="0">Тоглоогүй</option>
                                                <option <?php if ($play_status == 1) echo "selected" ?> value="1">Тоглосон</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div id="play_status_row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" id="team_one_point" name="team_one_point" value="<?= $team_one_point ?>" class="form-control" placeholder="Эзэн багын оноо оруулах">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" id="team_two_point" name="team_two_point" value="<?= $team_two_point ?>" class="form-control" placeholder="Зочин багын оноо оруулах">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-12">
                                                <select class="default-select wide form-control" id="win_status" name="win_status">
                                                    ...
                                                    <option <?php if ($win_status == 1) echo "selected" ?> value="1">Эзэн баг хожсон</option>
                                                    <option <?php if ($win_status == 2) echo "selected" ?> value="2">Зочин баг хожсон</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="datetime-local" id="play_date" name="play_date" value="<?= $play_date ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea style="height: 150px;" id="description" name="description" class="form-control" placeholder="Тайлбар оруулах"><?= $description ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="text" id="address" name="address" value="<?= $address ?>" class="form-control" placeholder="Хаяг оруулах" required>
                                        </div>
                                    </div>
